...
static GtkBox* create_check_box              (GtkBox          *tab,
                                              ...
                                              const gchar     *name,
                                              gboolean        init,
                                              void            (callback)(GtkToggleButton*, MEMGraphOptions*),
                                              MEMGraphOptions *cb_data,
...
static void    setup_color_option            (GtkBox          *vbox,
                                              ...
                                              const gchar     *name,
                                              const gchar     *tooltip,
                                              void            (callback)(GtkColorButton*, MEMGraph*));
...
static void    change_color_5                (GtkColorButton  *button,
                                              MEMGraph        *base);
static void    update_sensitivity            (const MEMGraphOptions *data);
...
static void    change_load_threshold         (GtkSpinButton   *button,
                                              MEMGraph        *base);
static gboolean update_cb                    (MEMGraphOptions *data);

void
create_options (XfcePanelPlugin *plugin, MEMGraph *base)
{
    ...
    dlg = xfce_titled_dialog_new_with_buttons (_("MEM Graph Properties"),
...
create_check_box (GtkBox *tab, GtkSizeGroup *sg, const gchar *name, gboolean init,
                  void (callback)(GtkToggleButton*, MEMGraphOptions*), MEMGraphOptions *cb_data,
                  GtkToggleButton **out_checkbox)
{
    GtkBox *hbox;
    GtkWidget *checkbox;
...
create_drop_down (GtkBox *tab, GtkSizeGroup *sg, const gchar *name,
                  ...
                  void (callback)(GtkComboBox*, MEMGraphOptions*), MEMGraphOptions *cb_data)
{
    GtkBox *hbox;
    GtkWidget *combo;
    gsize i;
...
static void
destroy_cb (GtkWidget *dlg, MEMGraphOptions *data)
{
    if (data->timeout_id)
...
static void
setup_update_interval_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraphOptions *data)
{
...
static void
setup_tracked_core_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraphOptions *data)
{
...
static void
setup_size_option (GtkBox *vbox, GtkSizeGroup *sg, XfcePanelPlugin *plugin, MEMGraph *base)
{
    GtkBox *hbox;
    GtkWidget *size;
...
static void
setup_load_threshold_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraph *base)
{
    GtkBox *hbox;
    GtkWidget *threshold;
...
static GtkBox*
setup_per_core_spacing_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraph *base)
{
    GtkBox *hbox;
    GtkWidget *spacing;
...
static void
setup_command_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraphOptions *data)
{
    GtkBox *hbox;
...
static void
setup_color_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraphOptions *data,
...
static void
setup_mode_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraphOptions *data)
{
...
static void
setup_color_mode_option (GtkBox *vbox, GtkSizeGroup *sg, MEMGraphOptions *data)
{
...
static void
change_in_terminal (GtkToggleButton *button, MEMGraphOptions *data)
{
...
static void
change_startup_notification (GtkToggleButton *button, MEMGraphOptions *data)
{
...
static void
change_command (GtkEntry *entry, MEMGraphOptions *data)
{
...
static void
change_color (GtkColorButton *button, MEMGraph *base, guint number)
{
    GdkRGBA color;
...
static void
change_color_0 (GtkColorButton *button, MEMGraph *base)
{
    change_color (button, base, BG_COLOR);
}

static void
change_color_1 (GtkColorButton *button, MEMGraph *base)
{
    change_color (button, base, FG_COLOR1);
}

static void
change_color_2 (GtkColorButton *button, MEMGraph *base)
{
    change_color (button, base, FG_COLOR2);
}

static void
change_color_3 (GtkColorButton *button, MEMGraph *base)
{
    change_color (button, base, FG_COLOR3);
}

static void
change_color_4 (GtkColorButton *button, MEMGraph *base)
{
...
static void
change_color_5 (GtkColorButton *button, MEMGraph *base)
{
    change_color (button, base, SMT_ISSUES_COLOR);
}

static void
update_sensitivity (const MEMGraphOptions *data)
{
    const MEMGraph *base = data->base;
...
static void
change_mode (GtkComboBox *combo, MEMGraphOptions *data)
{
...
static void
change_color_mode (GtkComboBox *combo, MEMGraphOptions *data)
{
...
static void
response_cb (GtkWidget *dlg, gint response, MEMGraph *base)
{
...
static void
change_frame (GtkToggleButton *button, MEMGraphOptions *data)
{
    set_frame (data->base, gtk_toggle_button_get_active (button));
}

static void
change_border (GtkToggleButton *button, MEMGraphOptions *data)
{
    set_border (data->base, gtk_toggle_button_get_active (button));
}

static void
change_bars (GtkToggleButton *button, MEMGraphOptions *data)
{
...
static void
change_per_core (GtkToggleButton *button, MEMGraphOptions *data)
{
...
static void
change_per_core_spacing (GtkSpinButton *button, MEMGraph *base)
{
    set_per_core_spacing (base, gtk_spin_button_get_value_as_int (button));
}

static void
change_size (GtkSpinButton *button, MEMGraph *base)
{
    set_size (base, gtk_spin_button_get_value_as_int (button));
}

static void
change_smt (GtkToggleButton *button, MEMGraphOptions *data)
{
...
static void
change_load_threshold (GtkSpinButton *button, MEMGraph *base)
{
    set_load_threshold (base, gtk_spin_button_get_value (button) / 100);
}

static void change_time_scale (GtkToggleButton *button, MEMGraphOptions *data)
{
    set_nonlinear_time (data->base, gtk_toggle_button_get_active (button));
}

static void change_update (GtkComboBox *combo, MEMGraphOptions *data)
{
    set_update_rate (data->base, gtk_combo_box_get_active (combo));
}

static void change_core (GtkComboBox *combo, MEMGraphOptions *data)
{
...
static gboolean
update_cb (MEMGraphOptions *data)
{
    const MEMGraph *base = data->base;
    gchar *smt_text;

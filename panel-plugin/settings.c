...
void
read_settings (XfcePanelPlugin *plugin, MEMGraph *base)
{
    char *file;
    XfceRc *rc;

    MEMGraphUpdateRate rate = RATE_NORMAL;
    MEMGraphMode mode = MODE_NORMAL;
    guint color_mode = 0;
    gboolean bars = TRUE;
...
void
write_settings (XfcePanelPlugin *plugin, MEMGraph *base)
{
    XfceRc *rc;
    char *file;
    guint i;
